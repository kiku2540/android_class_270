...
public class OrderDrtailActivity extends AppCompatActivity implements GeoCodingTask.GeoCodingResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap map) {
                googleMap = map;
                (new GeoCodingTask(OrderDrtailActivity.this)).execute("台北市大安區羅斯福路四段一號");
            }
        });
    }
    @Override
